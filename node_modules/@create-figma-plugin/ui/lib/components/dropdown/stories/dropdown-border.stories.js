...
export const DynamicallySetOptions = function () {
    ...
    return (h(Fragment, null,
        ...
        h(Dropdown, { onChange: handleChange, options: options, placeholder: "placeholder", value: value, variant: "border" })));
};
export const FlexParent = function () {
    ...
    return (h("div", { style: style },
        h(Dropdown, { onChange: handleChangeA, options: optionsA, value: valueA, variant: "border" }),
        ")",
        h(Dropdown, { onChange: handleChangeB, options: optionsB, value: valueB, variant: "border" }),
        ")"));
};
