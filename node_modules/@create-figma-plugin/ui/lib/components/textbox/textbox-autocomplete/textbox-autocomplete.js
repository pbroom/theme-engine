...
export function TextboxAutocomplete({ disabled = false, filter = false, icon, name, onInput = function () { }, onValueInput = function () { }, placeholder, propagateEscapeKeyDown = true, revertOnEscapeKeyDown = false, spellCheck = false, strict = false, top = false, value, variant, ...rest }) {
    ...
    return (h("div", { ref: rootElementRef, class: createClassName([
        ...
        h("div", { class: textboxStyles.inner },
            h("input", { ...rest, ref: inputElementRef, class: textboxStyles.input, disabled: disabled === true, name: name, onFocus: handleFocus, onInput: handleInput, onKeyDown: handleKeyDown, onPaste: handlePaste, placeholder: placeholder, tabIndex: disabled === true ? -1 : 0, type: "text", value: value }),
            ...
            h("div", { ref: menuElementRef, class: createClassName([
                ...
                return (h("label", { key: index, class: createClassName([
                    ...
                    h("input", { ...rest, checked: value === option.value, class: menuStyles.input, disabled: option.disabled === true, name: name, onChange: handleOptionChange, onMouseMove: handleOptionMouseMove, spellcheck: spellCheck, tabIndex: -1, type: "radio", value: `${option.value}`, [ITEM_ID_DATA_ATTRIBUTE_NAME]: option.id }),
