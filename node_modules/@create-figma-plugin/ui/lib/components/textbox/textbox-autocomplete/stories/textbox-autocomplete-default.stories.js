...
export const PlaceholderFocused = function () {
    ...
    return (h(TextboxAutocomplete, { ...useInitialFocus(), onInput: handleInput, options: options, placeholder: "placeholder", value: value }));
};
...
export const IconDisabled = function () {
    ...
    return (h(TextboxAutocomplete, { disabled: true, icon: h(IconLayerFrame16, null), onInput: handleInput, options: options, value: value }));
};
...
export const IconTextDisabled = function () {
    ...
    return (h(TextboxAutocomplete, { disabled: true, icon: "X", onInput: handleInput, options: options, value: value }));
};
