...
export const PlaceholderFocused = function () {
    ...
    return (h(TextboxMultiline, { ...useInitialFocus(), onInput: handleInput, placeholder: "placeholder", value: value }));
};
...
export const Rows = function () {
    ...
    return h(TextboxMultiline, { onInput: handleInput, rows: 1, value: value });
};
