...
export function Disclosure({ children, onClick, open, propagateEscapeKeyDown = true, title, ...rest }) {
    ...
    return (h(Fragment, null,
        h("label", { class: styles.label },
            h("input", { ...rest, checked: open === true, class: styles.input, onClick: onClick, onKeyDown: handleKeyDown, tabIndex: 0, type: "checkbox" }),
