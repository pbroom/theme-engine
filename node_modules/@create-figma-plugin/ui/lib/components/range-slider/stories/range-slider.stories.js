...
export const WithTextboxNumeric = function () {
    ...
    return (h(Fragment, null,
        h(RangeSlider, { maximum: 100, minimum: 0, onInput: handleInput, value: value }),
        h(VerticalSpace, { space: "small" }),
        h(TextboxNumeric, { maximum: 100, minimum: 0, onInput: handleInput, value: value, variant: "border" })));
};
