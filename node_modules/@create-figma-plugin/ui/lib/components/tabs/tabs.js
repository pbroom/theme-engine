...
export function Tabs({ name, onChange = function () { }, onValueChange = function () { }, options, propagateEscapeKeyDown = true, value, ...rest }) {
    ...
    return (h(Fragment, null,
        h("div", { class: styles.tabs }, options.map(function (option, index) {
            return (h("label", { key: index, class: styles.label },
                h("input", { ...rest, checked: value === option.value, class: styles.input, name: name, onChange: handleChange, onKeyDown: handleKeyDown, tabIndex: 0, type: "radio", value: option.value, [ITEM_ID_DATA_ATTRIBUTE_NAME]: `${index}` }),
