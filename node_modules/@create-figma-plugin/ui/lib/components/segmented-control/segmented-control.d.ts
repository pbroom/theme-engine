...
export type SegmentedControlProps<Name extends string, Value extends boolean | number | string> = {
    disabled?: boolean;
    name?: Name;
...
export type SegmentedControlOption<Value extends boolean | number | string = string> = {
    disabled?: boolean;
