(() => {
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/b38d898c-5f4b-4f5c-8211-a565e8b92941/tailwind.js
...
`;
  ...
  var init_cam16 = __esm({
    "node_modules/@material/material-color-utilities/hct/cam16.js"() {
      ...
      Cam16 = class {
         ...
         */
        constructor(hue2, chroma2, j3, q2, m3, s3, jstar, astar, bstar) {
          this.hue = hue2;
          this.chroma = chroma2;
          this.j = j3;
          this.q = q2;
        ...
        static fromIntInViewingConditions(argb, viewingConditions) {
          ...
          const hue2 = atanDegrees < 0 ? atanDegrees + 360 : atanDegrees >= 360 ? atanDegrees - 360 : atanDegrees;
          const hueRadians = hue2 * Math.PI / 180;
          ...
          const huePrime = hue2 < 20.14 ? hue2 + 360 : hue2;
          ...
          return new Cam16(hue2, c3, j3, q2, m3, s3, jstar, astar, bstar);
        }
        /**
        ...
        static fromXyzInViewingConditions(x2, y2, z3, viewingConditions) {
          ...
          const astar = mstar * Math.cos(hueRadians);
          const bstar = mstar * Math.sin(hueRadians);
          return new Cam16(hue2, C2, J, Q, M2, s3, jstar, astar, bstar);
        }
  ...
  var init_hct_solver = __esm({
    "node_modules/@material/material-color-utilities/hct/hct_solver.js"() {
      ...
      HctSolver = class {
         ...
         * otherwise.
         */
        static findResultByJ(hueRadians, chroma2, y2) {
          ...
          for (let iterationRound = 0; iterationRound < 5; iterationRound++) {
            ...
            const alpha = chroma2 === 0 || j3 === 0 ? 0 : chroma2 / Math.sqrt(jNormalized);
         ...
         */
        static solveToInt(hueDegrees, chroma2, lstar) {
          if (chroma2 < 1e-4 || lstar < 1e-4 || lstar > 99.9999) {
            return argbFromLstar(lstar);
          }
          hueDegrees = sanitizeDegreesDouble(hueDegrees);
          const hueRadians = hueDegrees / 180 * Math.PI;
          const y2 = yFromLstar(lstar);
          const exactAnswer = HctSolver.findResultByJ(hueRadians, chroma2, y2);
          if (exactAnswer !== 0) {
            return exactAnswer;
          }
         ...
         * sufficiently close, and chroma will be maximized.
         */
        static solveToCam(hueDegrees, chroma2, lstar) {
          return Cam16.fromInt(HctSolver.solveToInt(hueDegrees, chroma2, lstar));
        }
      };
  ...
  var init_hct = __esm({
    "node_modules/@material/material-color-utilities/hct/hct.js"() {
      ...
      init_viewing_conditions();
      Hct = class {
        static from(hue2, chroma2, tone) {
          return new Hct(HctSolver.solveToInt(hue2, chroma2, tone));
        }
        /**
         * @param argb ARGB representation of a color.
  ...
  function findDesiredChromaByTone(hue2, chroma2, tone, byDecreasingTone) {
    let answer = tone;
    let closestToChroma = Hct.from(hue2, chroma2, tone);
    if (closestToChroma.chroma < chroma2) {
      let chromaPeak = closestToChroma.chroma;
      while (closestToChroma.chroma < chroma2) {
        answer += byDecreasingTone ? -1 : 1;
        const potentialSolution = Hct.from(hue2, chroma2, answer);
        if (chromaPeak > potentialSolution.chroma) {
          break;
        }
        if (Math.abs(potentialSolution.chroma - chroma2) < 0.4) {
          break;
        }
        const potentialDelta = Math.abs(potentialSolution.chroma - chroma2);
        const currentDelta = Math.abs(closestToChroma.chroma - chroma2);
  ...
  var init_tonal_palette = __esm({
    "node_modules/@material/material-color-utilities/palettes/tonal_palette.js"() {
      ...
      TonalPalette = class {
         ...
         */
        static fromHueAndChroma(hue2, chroma2) {
          return new TonalPalette(hue2, chroma2, TonalPalette.createKeyColor(hue2, chroma2));
        }
        constructor(hue2, chroma2, keyColor) {
          this.hue = hue2;
          this.chroma = chroma2;
          this.keyColor = keyColor;
          this.cache = /* @__PURE__ */ new Map();
        }
        static createKeyColor(hue2, chroma2) {
          const startTone = 50;
          let smallestDeltaHct = Hct.from(hue2, chroma2, startTone);
          let smallestDelta = Math.abs(smallestDeltaHct.chroma - chroma2);
          for (let delta = 1; delta < 50; delta += 1) {
            if (Math.round(chroma2) === Math.round(smallestDeltaHct.chroma)) {
              return smallestDeltaHct;
            }
            const hctAdd = Hct.from(hue2, chroma2, startTone + delta);
            const hctAddDelta = Math.abs(hctAdd.chroma - chroma2);
            if (hctAddDelta < smallestDelta) {
              smallestDelta = hctAddDelta;
              smallestDeltaHct = hctAdd;
            }
            const hctSubtract = Hct.from(hue2, chroma2, startTone - delta);
            const hctSubtractDelta = Math.abs(hctSubtract.chroma - chroma2);
    ...
    "node_modules/@material/material-color-utilities/scheme/dynamic_scheme.js"() {
      ...
      DynamicScheme = class {
        ...
        static getRotatedHue(sourceColor, hues, rotations) {
          const sourceHue2 = sourceColor.hue;
          ...
          for (let i3 = 0; i3 <= size - 2; i3++) {
            ...
            if (thisHue < sourceHue2 && sourceHue2 < nextHue) {
              return sanitizeDegreesDouble(sourceHue2 + rotations[i3]);
            }
          }
          return sourceHue2;
        }
      ...
      Score = class {
        ...
        static score(colorsToPopulation, options) {
          ...
          for (const [argb, population] of colorsToPopulation.entries()) {
            const hct = Hct.fromInt(argb);
            colorsHct.push(hct);
            const hue2 = Math.floor(hct.hue);
            huePopulation[hue2] += population;
            populationSum += population;
          }
          const hueExcitedProportions = new Array(360).fill(0);
          for (let hue2 = 0; hue2 < 360; hue2++) {
            const proportion = huePopulation[hue2] / populationSum;
            for (let i3 = hue2 - 14; i3 < hue2 + 16; i3++) {
          ...
          for (const hct of colorsHct) {
            const hue2 = sanitizeDegreesInt(Math.round(hct.hue));
            const proportion = hueExcitedProportions[hue2];
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/d66cfbb6-0ef4-4b2c-8c23-1d4eab8e1930/tailwind.js
...
`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/8fedd294-6895-425a-821e-8c5a21283b04/loading-indicator.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/8565c496-b27e-4e56-8da8-f49ca07c47b8/button.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/b9c0f88a-0335-44cb-b560-1008e48a1222/icon.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/a340309c-bedc-4aac-be37-0f3a897b877e/checkbox.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/83db4664-19c5-4e4f-a2ba-962a0c67e130/divider.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/1e8b54ba-5d52-4d7d-ad73-9c82893d2580/menu.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/ff2d4327-5123-4182-bfbc-3e5181ab74c3/dropdown.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/07feee0a-7027-40fe-bafd-f4fc176d6013/icon-button.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/3f211424-7b01-4e6b-8f02-96978d4940c7/text.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/ea59c3f3-1842-406e-ad1b-7ea5e8872e5b/range-slider.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/8e2f58f8-7db8-431d-8800-afb11e125364/textbox.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/364cefe1-4089-426c-bc33-d0349df7e183/textbox-color.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/8b7a616f-68cc-4e8a-a77e-ded441fae735/textbox-multiline.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/113b7642-8bb2-45a2-833e-fa406fc346b4/textbox.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/8422dc7b-7c35-41c2-847a-2f86abcd4fcd/textbox-numeric.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/88d416b6-3444-40c3-9fae-1da7a7eb7593/muted.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/88f32c55-9979-4cd7-9966-a4fca916d0b8/columns.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/039effbc-d627-47a1-bee8-9558459ee472/container.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/0a850144-239a-44c1-83e0-a144721ba6b7/vertical-space.module.js
...
/*# sourceMappingURL=data:application/json;base64, */`;
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/4499e27a-3488-45c2-9295-49d16fc4e405/base.js
  var init_base = __esm({
    "../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/4499e27a-3488-45c2-9295-49d16fc4e405/base.js"() {
...
`;
  ...
  // src/utility.ts
  function mapValues(keyName, values) {
    return values.map((value2) => ({ [keyName]: value2 }));
  }
  ...
  function convertNumberToStringArray(numbers) {
    return numbers.map((n2) => n2.toString());
  }
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/c36a45c1-cf08-477c-ad89-ba6566619cd8/tailwind.js
...
`;
  ...
  // src/components/tone-field.tsx
  var ToneField, tone_field_default;
  var init_tone_field = __esm({
    "src/components/tone-field.tsx"() {
      "use strict";
      init_preact_module();
      init_hooks_module();
      ...
      init_utility();
      init_tailwind3();
      ToneField = ({ tones, setToneStops }) => {
        const [textAreaValue, setTextAreaValue] = h2(`${tones}`);
        function handleTextAreaInput(event) {
          const newTextAreaValue = event.currentTarget.value;
          setTextAreaValue(newTextAreaValue);
          const numbers = Array.from({ length: 101 }, (_2, i3) => i3);
          const newToneStops = getStopsFromString(newTextAreaValue).length > 0 ? getStopsFromString(newTextAreaValue) : numbers;
      ...
      ThemeColor = class {
        ...
        componentDidUpdate(prevProps) {
          if (this.state.sourceColor !== prevProps.sourceColor) {
            this.setState(__spreadProps(__spreadValues({}, prevProps), {
          ...
          if (this.state.themeColor !== prevProps.themeColor) {
            this.setState(__spreadProps(__spreadValues({}, this.state), { themeColor: this.state.themeColor }));
          }
          if (this.state.hueCalc !== prevProps.hueCalc) {
            this.setState(__spreadProps(__spreadValues({}, prevProps), { hueCalc: this.state.hueCalc }));
            this.setHue(this.state.themeColor.getHue());
          }
          if (this.state.chromaCalc !== prevProps.chromaCalc) {
            this.setState(__spreadProps(__spreadValues({}, prevProps), { chromaCalc: this.state.chromaCalc }));
            this.setChroma(this.state.themeColor.getChroma());
          }
          if (this.state.name !== prevProps.name) {
            this.setState(__spreadProps(__spreadValues({}, prevProps), { name: this.state.name }));
          }
          if (this.state.aliases !== prevProps.aliases) {
            this.setState(__spreadProps(__spreadValues({}, prevProps), { aliases: this.state.aliases }));
          }
        }
        ...
        set hueCalc(hueCalc2) {
          this.state.hueCalc = hueCalc2;
        }
        setHueCalc(hueCalc2) {
          this.state.hueCalc = hueCalc2;
        }
        ...
        set chromaCalc(chromaCalc2) {
          this.state.chromaCalc = chromaCalc2;
        }
        setChromaCalc(chromaCalc2) {
          this.state.chromaCalc = chromaCalc2;
        }
        setChroma(chroma) {
  ...
  // ../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/71d7dd2b-602f-4611-8bd7-abbc98cb7ce1/tailwind.js
  var init_tailwind4 = __esm({
    "../../../private/var/folders/9b/7w9djy9j5dlfjn79khk4l92h0000gn/T/71d7dd2b-602f-4611-8bd7-abbc98cb7ce1/tailwind.js"() {
      if (document.getElementById("daf6ec3404") === null) {
        const element = document.createElement("style");
        element.id = "daf6ec3404";
...
`;
  ...
  // src/components/tone-select.tsx
  var ToneSelect;
  var init_tone_select = __esm({
    "src/components/tone-select.tsx"() {
      "use strict";
      init_preact_module();
      init_hooks_module();
      ...
      ToneSelect = ({
        ...
        const [dropdownValue, setDropdownValue] = h2(
          toneOptions[2].value
        );
  ...
  // src/components/alias-input.tsx
  var AliasInput;
  var init_alias_input = __esm({
    "src/components/alias-input.tsx"() {
      "use strict";
      init_preact_module();
      init_hooks_module();
      ...
      AliasInput = ({
        ...
        const [aliasName, setAliasName] = h2(name || "Alias name");
        const [modesArray, setModesArray] = h2(modes || []);
        const [tonesArray, setTonesArray] = h2(tones || []);
        const [, setOptionId] = h2(null);
        const [, setDropdownValue] = h2(value2 || null);
        function handleAliasNameChange(event) {
          const newAliasName = event.currentTarget.value;
          setAliasName(newAliasName);
        }
        function handleOptionIdChange(newOptionId) {
          setOptionId(newOptionId);
        }
        function handleDropdownValueChange(newDropdownValue) {
          setDropdownValue(newDropdownValue);
          onDropdownValueChange(newDropdownValue);
        }
        p2(() => {
        ...
        p2(() => {
          setDropdownValue(value2 || null);
        }, [value2]);
        function modeDropdowns(modes2) {
          return modes2.map((mode) => {
            return /* @__PURE__ */ y(k, null, /* @__PURE__ */ y(
              ToneSelect,
              {
                options: tonesArray,
                modeName: mode,
                onOptionIdChange: (newOptionId) => handleOptionIdChange(newOptionId != null ? newOptionId : ""),
                onDropdownValueChange: (newDropdownValue) => handleDropdownValueChange(String(newDropdownValue))
              }
            ));
          });
        }
        return /* @__PURE__ */ y(k, null, /* @__PURE__ */ y(Textbox, { value: aliasName || "color", onInput: handleAliasNameChange }), modeDropdowns(modesArray));
      };
    }
  });

  // src/components/alias-manager.tsx
  var AliasManager;
  var init_alias_manager = __esm({
    "src/components/alias-manager.tsx"() {
      "use strict";
      init_preact_module();
      init_hooks_module();
      ...
      init_alias_input();
      init_utility();
      AliasManager = ({ themeColor }, modes) => {
        const [aliasName, setAliasName] = h2("");
        const [dropdownValue, setDropdownValue] = h2("");
        const [optionId, setOptionId] = h2("");
        p2(() => {
        ...
        const handleAliasNameChange = (newAliasName) => {
          setAliasName(newAliasName);
        };
        const handleDropdownValueChange = (newDropdownValue) => {
          setDropdownValue(newDropdownValue);
        };
        const handleOptionIdChange = (newOptionId) => {
          setOptionId(newOptionId);
        };
        ...
        const createAliasInput = () => {
          return /* @__PURE__ */ y("div", { className: "flex flex-row" }, /* @__PURE__ */ y(
            AliasInput,
            {
          ...
          ), /* @__PURE__ */ y(IconButton, { onClick: () => {
          } }, /* @__PURE__ */ y(IconMinus32, null)));
        };
        const aliasInputs = themeColor.aliases.map((alias) => {
          createAliasInput();
        });
        return /* @__PURE__ */ y(k, null, /* @__PURE__ */ y(Text, null, /* @__PURE__ */ y(Muted, null, "Alias Manager")), /* @__PURE__ */ y(Button, { onClick: () => {
        } }, "Add Alias"));
      };
    }
  });
  ...
  function Plugin() {
    ...
    const [hue2, setHue] = h2(
      themeColor.getThemeColor().getHue("rounded")
    );
    const [chroma2, setChroma] = h2(
    ...
    const [hctHueValue, setHctHueValue] = h2(`${hue2}`);
    const [hctChromaValue, setHctChromaValue] = h2(`${chroma2}`);
    ...
    function handleClick(type) {
      ...
      const toneStops3 = themeColor.getTones();
      if (!optionId) {
        return;
      }
    ...
    function getSelectedCollection(collections2, dropdownValue2) {
      return collections2.find((collection) => collection.name === dropdownValue2);
    }
    function getCollectionModes(selectedCollection) {
    ...
    return /* @__PURE__ */ y("div", { id: "container-wrap", className: "py-4 overflow-y-auto" }, /* @__PURE__ */ y(Container, { space: "medium" }, /* @__PURE__ */ y(Columns, { space: "extraSmall" }, /* @__PURE__ */ y("div", { className: "w-60" }, /* @__PURE__ */ y(Text, null, /* @__PURE__ */ y(Muted, null, "Color/palette name")), /* @__PURE__ */ y(VerticalSpace, { space: "extraSmall" }), /* @__PURE__ */ y(
      Textbox,
      {
    ...
    )), /* @__PURE__ */ y("div", { className: "w-60" }, /* @__PURE__ */ y(Text, null, /* @__PURE__ */ y(Muted, null, "Variable collection")), /* @__PURE__ */ y(VerticalSpace, { space: "extraSmall" }), /* @__PURE__ */ y(
      Dropdown,
      {
        onChange: handleDropdownChange,
    ...
    ))), /* @__PURE__ */ y(VerticalSpace, { space: "small" }), /* @__PURE__ */ y(Columns, { space: "extraSmall" }, /* @__PURE__ */ y("div", { className: "w-60" }, /* @__PURE__ */ y(Text, null, /* @__PURE__ */ y(Muted, null, "Select a color")), /* @__PURE__ */ y("div", { className: "flex flex-row align-middle" }, /* @__PURE__ */ y("div", { className: "w-24" }, /* @__PURE__ */ y(
      TextboxColor,
      {
        id: "hexColor1",
        hexColor,
    ...
    )), /* @__PURE__ */ y("div", { className: "p-1 text-center flex flex-row justify-end items-center grow" }, /* @__PURE__ */ y(Text, { align: "right" }, /* @__PURE__ */ y(Muted, null, "H: ", hue2, " C: ", chroma2, " T: ", tone))))), /* @__PURE__ */ y("div", { id: "plugin-column-2", className: "w-60" }, /* @__PURE__ */ y(gradient_preview_default, { hexColor }))), /* @__PURE__ */ y(VerticalSpace, { space: "extraSmall" }), /* @__PURE__ */ y(Columns, { space: "extraSmall" }, /* @__PURE__ */ y("div", { className: "w-60" }, /* @__PURE__ */ y(Text, null, /* @__PURE__ */ y(Muted, null, "Adjust hue and chroma to taste")), /* @__PURE__ */ y(VerticalSpace, { space: "extraSmall" }), /* @__PURE__ */ y(Columns, { space: "extraSmall" }, /* @__PURE__ */ y("div", null, /* @__PURE__ */ y(
      TextboxNumeric,
      {
        maximum: 360,
        minimum: 0,
    ...
    )))), /* @__PURE__ */ y("div", { className: "w-60" }, /* @__PURE__ */ y(gradient_preview_default, { hexColor: augmentedColor }))), /* @__PURE__ */ y(VerticalSpace, { space: "extraSmall" }), /* @__PURE__ */ y(Columns, { space: "extraSmall" }, /* @__PURE__ */ y("div", { className: "w-60" }, /* @__PURE__ */ y(Text, null, /* @__PURE__ */ y(Muted, null, "Select tones")), /* @__PURE__ */ y(VerticalSpace, { space: "extraSmall" }), /* @__PURE__ */ y(tone_field_default, { tones: toneStops2, setToneStops })), /* @__PURE__ */ y("div", { className: "w-60" }, /* @__PURE__ */ y(gradient_preview_default, { hexColor: augmentedColor, stops: toneStops2 }))), /* @__PURE__ */ y(VerticalSpace, { space: "large" }), /* @__PURE__ */ y(Divider, null), /* @__PURE__ */ y(VerticalSpace, { space: "large" }), /* @__PURE__ */ y(AliasManager, { themeColor, modes: collectionModes }), /* @__PURE__ */ y(VerticalSpace, { space: "large" }), /* @__PURE__ */ y(Columns, { space: "extraSmall" }, /* @__PURE__ */ y("div", { className: "w-60" }, /* @__PURE__ */ y(
      Checkbox,
      {
    ...
    ), /* @__PURE__ */ y(VerticalSpace, { space: "large" }), /* @__PURE__ */ y(Button, { onClick: () => handleClick("createVariables"), fullWidth: true }, "Build Variables"), /* @__PURE__ */ y(VerticalSpace, { space: "extraSmall" }), /* @__PURE__ */ y(
      Button,
      {
      ...
      "Print themeColor"
    )), /* @__PURE__ */ y("div", { className: "w-60" })), /* @__PURE__ */ y(VerticalSpace, { space: "large" }), /* @__PURE__ */ y(Columns, { space: "extraSmall" }, /* @__PURE__ */ y("div", { className: "w-60" }), /* @__PURE__ */ y("div", { className: "w-60" })), /* @__PURE__ */ y(VerticalSpace, { space: "large" }), /* @__PURE__ */ y(Columns, { space: "extraSmall" }, /* @__PURE__ */ y("div", { className: "w-60" }), /* @__PURE__ */ y("div", { className: "w-60" })), /* @__PURE__ */ y(VerticalSpace, { space: "large" })));
  }
  var ui_default;
  var init_ui = __esm({
    "src/ui.tsx"() {
