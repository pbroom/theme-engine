...
export function Plugin() {
    ...
    const startingThemeColor = new ThemeColor(
        defaultColor,
        defaultName,
        defaultPaletteTones,
        '',
    ...
    const [themeColor, setThemeColor] =
        useState<ThemeColor>(startingThemeColor);
    console.log(startingThemeColor);

    setThemeColor(startingThemeColor);

    const maxChromaAtHue = Math.round(
        maxChromaAtTonePerHue[themeColor.getThemeColor().getHue('rounded')]
            .chroma,
    );
    ...
    const [checkboxBindStyles, setCheckboxBindStyles] =
    ...
    function handleDropdownChange(
        ...
        const newOptionId = event.currentTarget.getAttribute(
    ...
    function getSelectedCollection(
        ...
        return collections.find(
            (collection) => collection.name === dropdownValue,
        );
    }

    function getCollectionModes(
        selectedCollection: VariableCollection,
    ): string[] {
    ...
    // Rendering the UI
    return (
        <div id="container-wrap" className="overflow-y-auto py-4">
            <Container space="medium">
                ...
                <Columns space="extraSmall">
                    <div className="w-60">
                        ...
                        <div className="flex flex-row align-middle">
                            ...
                            <div className="flex grow flex-row items-center justify-end p-1 text-center">
                                <Text align="right">
                                    <Muted>
                ...
                <Columns space="extraSmall">
                    <div className="w-60">
                        ...
                        <ToneField
                            tones={toneStops}
                            setToneStops={setToneStops}
                        />
                    </div>
                    <div className="w-60">
                        <GradientPreview
                            hexColor={augmentedColor}
                            stops={toneStops}
                        />
                    </div>
                </Columns>
                ...
                <Divider />
                <VerticalSpace space="large" />
                {/* <AliasManager themeColor={themeColor} modes={} /> */}
                <VerticalSpace space="large" />
                <Columns space="extraSmall">
                    <div className="w-60">
                        <Checkbox
                        ...
                        >
                            <Text>
                                Overwrite existing variables if they have the
                                same name
                            </Text>
                        </Checkbox>
                        <VerticalSpace space="large" />
                        ...
                        <VerticalSpace space="large" />
                        <Button
                            onClick={() => handleClick('createVariables')}
                            fullWidth
                        >
                            Build Variables
                        </Button>
